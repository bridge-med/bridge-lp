...
const styles = StyleSheet.create({
  ...
  hero: { borderWidth: StyleSheet.hairlineWidth, borderRadius: radius.lg, paddingVertical: spacing.xl, alignItems: 'center', gap: 4, marginBottom: spacing.xl },
  heroDur: { fontFamily: fonts.maruBlack, fontSize: 44, letterSpacing: 1 },
