...
| ページ | 役割 | 想定滞在 | 主な次の一歩 |
|---|---|---|---|
| Home | 最初の画面で誰に何が役立つかを伝え、道具への入口(おすすめ3点)を渡す。ヒーローはスクロールで場面が変わる固定ステージ(明るい場のガラスの立体 → 夜の場でゲームの実画面が主役)。動きを減らす設定・JS なしでは場面1だけの静止した1画面 | 30秒〜1分 | Products / 個別プロダクト / Philosophy / About / note |
