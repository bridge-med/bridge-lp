...
### 変更履歴
- v2.6 (2026-09-23): Homeの「おすすめ3つ」(カード)と独立した「考え方」セクションを外す。「ここでは、いろいろ試しています」(Compass の実画面と翻訳の2行 / 直し続けている Clinic Town 3D / 小さく試しているもの / Productsへの文字リンク)→ 本人の言葉と明朝の一文 → 入口(考え方・運営者・話をする・note)に。Heroの文言をサービス説明から話し言葉へ。
