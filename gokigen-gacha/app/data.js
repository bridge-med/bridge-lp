...
(function (global) {
  ...
  /* ---- カテゴリ(=回復タイプの系統) ------------------------------------ */
  // statLabel はカード結果画面の「回復タイプ +1」表示に使う。
  var CATEGORIES = [
    { id: 'body',   label: '体を戻す',             emoji: '🌱', statLabel: '体力',       tone: 'green'  },
    { id: 'head',   label: '頭を軽くする',         emoji: '☁️', statLabel: '思考の余白', tone: 'blue'   },
    { id: 'mood',   label: '気分を上げる',         emoji: '🧡', statLabel: 'ごきげん',   tone: 'orange' },
    { id: 'social', label: '人間関係から少し離れる', emoji: '🚪', statLabel: 'ひとり時間', tone: 'blue'   },
    { id: 'life',   label: '生活を整える',         emoji: '🏠', statLabel: '生活',       tone: 'green'  },
    { id: 'guilt',  label: '罪悪感を軽くする',     emoji: '🍵', statLabel: 'やさしさ',   tone: 'orange' },
    { id: 'rest',   label: '何もしないを許す',     emoji: '🍀', statLabel: 'ゆるし',     tone: 'green'  }
  ];

  /* ---- 状態カテゴリ(状態選択画面) -------------------------------------- */
  var STATES = [
    { id: 'sleepy',      label: '眠い',           emoji: '🌙', desc: 'とにかく眠い。体がまだ起きていない。' },
    { id: 'tired',       label: '疲れた',         emoji: '🔋', desc: '体力が減っていて、何かするのが重い。' },
    { id: 'heavyhead',   label: '頭が重い',       emoji: '🌫️', desc: '考えることが多くて、脳が詰まっている感じ。' },
    { id: 'irritated',   label: 'イライラする',   emoji: '💢', desc: '小さなことにも反応しそうな状態。' },
    { id: 'unmotivated', label: '何もしたくない', emoji: '🦥', desc: 'やる気が出ない。動き出しが重い。' },
    { id: 'nosocial',    label: '人と話したくない', emoji: '🚪', desc: '会話や返信を少し休みたい。' },
    { id: 'guilty',      label: '罪悪感だけある', emoji: '💧', desc: 'できていないことが気になるけど、動けない。' },
    { id: 'lonely',      label: 'なんとなく寂しい', emoji: '🫧', desc: '理由ははっきりしないけど、少し心細い。' },
    { id: 'infofatigue', label: '情報疲れ',       emoji: '📱', desc: 'スマホ、通知、SNS、連絡で頭がいっぱい。' },
    { id: 'busy',        label: '予定が多すぎる', emoji: '📅', desc: '今日の予定やタスクが詰まっていて余裕がない。' }
  ];
  ...
  var POTE = {
    ...
    emptyHistory: 'まだ回復履歴はありません。まずは1枚、カードを引いてみましょう。',
    emptyFavorites: 'お気に入りカードはまだありません。自分に合いそうなカードが出たら保存してみてください。'
  };
