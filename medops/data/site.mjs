/* ================================================================
   ...
   ---- manager-starter との棲み分け(2026-07-18 PM承認) ----
   医療管理実務ライブラリ(本サイト) = 施設運営・行政・バックオフィス実務
   (統合・管理医師変更・施設基準・事務長業務)。
   医療管理職スターター(manager-starter/) = チーム運営・対人マネジメント
   (新任管理職・1on1・会議・業務分担・上司報告・採用教育)。
   同一役割の成果物を両サイトに複製しない。本サイトの1on1シートは
   「定例の型」、manager-starter側は「初回(顔合わせ)専用」。
