/* ================================================================
   ...
   ---- medops との棲み分け(2026-07-18 社長指示で改定) ----
   医療管理職スターター(本サイト) = 「管理職としてどう振る舞うか」
   (1on1・上司報告・チーム運営・業務の任せ方・最初の7/30/90日)。
   医療管理実務ライブラリ(medops/) = 「具体的な実務をどう処理するか」
   (採用・入退職・施設基準・研修記録・レセプト・機器管理などの案件処理)。
   迷ったらこの2問で判断する。同一役割の成果物を両サイトに複製しない。
   採用・新人教育まわりの重なり(本サイトのパック収録の面接評価・
   新人受け入れ)の整理は社長判断待ち(台帳参照)。
   ================================================================ */
...
export const SITE = {
  ...
  sibling: {
    ...
    scope: '採用・入退職・施設基準・研修記録など、具体的な実務の処理はこちら',
  },
...
export const FOOTER_LINKS = {
  ...
  about: [
    ...
    { label: '医療管理実務ライブラリ(実務の処理はこちら)', href: '../medops/index.html' },
