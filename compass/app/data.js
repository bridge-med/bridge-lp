...
(function (root) {
  ...
  const ASSETS = {
    ...
    management:     { label: 'チーム推進',   word: 'チームを動かす', tag: 'チーム推進', ren: 'チームを動かし',     term: 'チームを動かす' }, // 橋の「マネジメント」と階層を分ける(2026-09-23 社長)
    ...
    expertise:      { label: '専門性',       word: '専門知識を使う', tag: '専門性',     ren: '専門知識を深め',       term: '専門知識を活かす' },
  };
  ...
  const ROLES = {
    specialist:     { interest: '臨床の専門性', label: '専門性を深める',             weights: { expertise: 0.6, hypothesis: 0.2, problemFinding: 0.2 } },
    educator:       { interest: '教育', label: '人を育てる',                 weights: { education: 0.6, empathy: 0.25, coordination: 0.15 } },
    manager:        { interest: '組織運営', label: 'チームを動かす',             weights: { management: 0.5, coordination: 0.3, empathy: 0.1, improvement: 0.1 } },
  ...
  const HEADLINES = {
    ...
    'improvement+management':   ['チームをまとめ、', '仕組みを整える力'],
    'coordination+management':  ['立場の違う人を、', 'ひとつのチームにする力'],
    ...
    'improvement+project':      ['仕組みを変え、', '定着させる力'],
    'creation+project':         ['アイデアを、', '最後まで運ぶ力'],
    'education+expertise':      ['専門性を、', '人に届ける力'],
    'empathy+expertise':        ['専門性で、', '人を支える力'],
    'expertise+problemFinding': ['専門性で、', '課題に向き合う力'],
    'expertise+hypothesis':     ['専門性を、', '問いで深める力'],
    'hypothesis+problemFinding': ['違和感から、', '問いを立てる力'],
    ...
    'education+improvement':    ['人を育て、', '仕組みを整える力'],
    'creation+improvement':     ['新しく考え、', '仕組みにする力'],
    'coordination+expertise':   ['専門知識で、', '人と人をつなぐ力'],
    'analysis+coordination':    ['数字を示し、', '人を動かす力'],
    'analysis+education':       ['数字を使って、', '人を育てる力'],
    'creation+education':       ['学びの場を、', '新しくつくる力'],
    'expertise+improvement':    ['専門性を、', '仕組みに変える力'],
    'analysis+expertise':       ['専門性を、', '数字で確かめる力'],
    'analysis+creation':        ['数字を手がかりに、', '新しく考える力'],
    'analysis+empathy':         ['数字と人の気持ちを、', '両方見る力'],
    'creation+expertise':       ['専門性から、', '新しいものを考える力'],
    'creation+problemFinding':  ['違和感を、', '新しい形にする力'],
    'analysis+problemFinding':  ['違和感を、', '数字で確かめる力'],
    'empathy+improvement':      ['人の気持ちを見て、', '仕組みを変える力'],
    'education+problemFinding': ['つまずきに気づき、', '人を育てる力'],
    'education+management':     ['人を育て、', 'チームを動かす力'],
    'empathy+problemFinding':   ['人の気持ちから、', '問題に気づく力'],
    'analysis+management':      ['数字を見て、', 'チームを動かす力'],
    'creation+management':      ['アイデアを、', 'チームで形にする力'],
    'expertise+management':     ['専門性を軸に、', 'チームを動かす力'],
    'empathy+management':       ['人の気持ちを見て、', 'チームを動かす力'],
  };
