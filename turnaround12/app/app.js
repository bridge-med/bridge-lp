    ...
    <section class="screen screen-top">
      <div class="crest" aria-hidden="true">
        <svg viewBox="0 0 64 64" fill="none">
          <rect x="8" y="14" width="48" height="40" rx="6" fill="#FBFAF7" stroke="#16233E" stroke-width="2.5"/>
          <path d="M14 42 L24 34 L32 38 L42 26 L50 22" stroke="#A98F63" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          <path d="M32 6 L36 14 H28 Z" fill="#16233E"/>
        </svg>
      </div>
