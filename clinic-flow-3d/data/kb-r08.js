 ...
 * 生成: 2026-08-31T03:55:10.232Z / 生成元: medical-kb/data/kb/r08/
...
(function (root, data) {
 ...
 "generated_at": "2026-08-31T03:55:10.232Z",
 ...
 "items": [
  ...
  },
  {
   ...
   "conditions": "精製ヒアルロン酸ナトリウムのディスポーザブル関節注キット。薬価663.00円/筒(医薬品マスター620004641・告示72号原典とも復号突合で一致)。第6部注射の薬剤料G100(15円以下は1点・15円超は「(薬価-15円)÷10、1点未満切り上げ+1点」)で66点。関節腔内注射(G010)と併せて算定。長期収載品の選定療養(患者希望で先発品を使う場合は保険給付が(選)セル631.50円ベースになり差額は特別料金)は、医師の判断で施行する関節注=「医療上必要があると認められる場合」の保険給付の枝に当たるため適用しない(保医発0327第9号第1の6・ゲーム上もこの枝のみ)",
   "exclusions": null,
   "countLimitText": null,
   "periodLimitText": null,
   "limit": null,
   ...
   "evidence": [
    ...
    },
    {
     ...
     "note": "【調査結果=当初見立ての棄却】「注射薬は選定療養の対象外」の否定的確認を試みたが、院内処方も対象でありマスターに(選)コード(670004641=631.50円)が実在=対象になりうる。ゲームは医師の判断で施行する注射=「医療上必要があると認められる場合」の保険給付の枝として663円/66点で算定し、患者希望の選定療養は扱わない(診療実態にも整合するゲーム上の判断)"
    }
   ]
  },
  {
