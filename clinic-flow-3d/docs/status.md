...
版: `ct3d-v87`(sw.js の VER)。公開URL: https://bridge-med.github.io/bridge-lp/clinic-flow-3d/
...
| ui/events.js | 通知の部品(バナー・トースト・モーダル)。v86 で game.js から抽出 |
| ui/dashboard.js | HUD・「今日の経営」(v86 抽出・v87 で再設計) |
| ui/nav.js | タブのナビゲーション(v86 抽出) |
...
- `node clinic-flow-3d/tests/*.test.mjs`(reimbursement/departments/kasan/zaisokan/town-map/decisions/main-internal/main-ophtha/main-psych の9本)
