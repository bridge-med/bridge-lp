  ...
  const M = {
    ...
    main: {
      ...
      preset: {
        ...
        jihiHide: ['selfReha', 'prpOn', 'goods'], // 自費リハ延長・PRP療法・物販(サポーター等)は運動器の自費(v82/v83 保留#45)
        ...
        textbook: {
          ...
          15: { t: '⑮ 自費は価値設計から', b: 'AGAは「保険でできないこと」への対価。価格は価値で決める。評判が低いうちは、治療への信頼がなければ売れない。' },
          17: { t: '⑰ 客層(セグメント)から逆算する', b: '高齢者=不眠や気分の相談。高校生はスクールカウンセラー経由。病院・企業・学校ごとに来る客層は違う — 営業先から選ぶ。' },
        },
        relHide: ['sports'],
