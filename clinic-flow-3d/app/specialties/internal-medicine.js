    ...
    main: {
      ...
      preset: {
        ...
        textbook: {
          ...
          14: { t: '⑮ 自費は価値設計から', b: 'AGAは「保険でできないこと」への対価。価格は価値で決める。評判が低いうちは売れない — 保険診療の信頼が自費の土台。' },
          16: { t: '⑰ 客層(セグメント)から逆算する', b: '高齢者=高血圧・糖尿病の継続管理。勤労者=健診がきっかけ。病院・ケアマネ・老健ごとに来る客層は違う — 営業先から選ぶ。' },
