    ...
    main: {
      ...
      preset: {
        ...
        textbook: {
          ...
          5: { t: '⑥ 継続管理はLTVで考える', b: '緑内障や糖尿病網膜症の管理は年単位で続く。1回の単価より、点眼と通院を途切れさせないことが生涯価値をいちばん動かす。' },
          9: { t: '⑨ 施設基準は経営の土台', b: '眼科には届出必須の施設基準が定められた項目がない。だからこそ検査や手術の記録を日々整える体制そのものが算定を支える土台になる。' },
          10: { t: '⑩ 分院は専従の壁', b: '分院の体制要件は施設ごとに満たす必要がある。本院の視能訓練士を分院に兼務させることはできない。分院展開のボトルネックは資金より採用になる。' },
          12: { t: '⑫ 設備投資は回収期間で決める', b: 'OCTや視野計、手術設備の導入は検査や手術の幅を広げる。だが判断基準は「欲しい」ではなく、投資が何日の診療で回収できるかという期間になる。' },
          15: { t: '⑮ 自費は価値設計から', b: 'AGAは「保険でできないこと」への対価。価格は価値で決める。評判が低いうちは、検査と診断への信頼がなければ売れない。' },
          17: { t: '⑰ 客層(セグメント)から逆算する', b: '高齢者=緑内障・白内障術後の管理。学校健診の二次検査は高校生。病院・老健・学校ごとに来る客層は違う — 営業先から選ぶ。' },
        },
        relHide: ['sports'],
        rel: {
