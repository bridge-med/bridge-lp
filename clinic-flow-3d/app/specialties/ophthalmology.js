    ...
    main: {
      ...
      preset: {
        ...
        textbook: {
          ...
          14: { t: '⑮ 自費は価値設計から', b: 'AGAは「保険でできないこと」への対価。価格は価値で決める。評判が低いうちは、検査と診断への信頼がなければ売れない。' },
          16: { t: '⑰ 客層(セグメント)から逆算する', b: '高齢者=緑内障・白内障術後の管理。学校健診の二次検査は高校生。病院・老健・学校ごとに来る客層は違う — 営業先から選ぶ。' },
        },
        relHide: ['sports'],
        rel: {
