  ...
  const CASES = [
    {
      ...
      choices: [
        ...
        { id: 'later', label: '還元の条件と時期を示し、当面は資金を確保する', note: '費用なし。余力−1。30日後に利益が続けば手当。届かなければ信頼が下がる',
          fx: { flag: 'py_promise', slack: -1 },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'none', label: '今は支援せず、希望として聞いておく', note: '費用なし。余力−1。取る人は自分で取る。学べる職場へ移る理由にもなる',
          fx: { slack: -1 },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'refuse', label: 'フルタイムを維持してもらう', note: '穴埋めの時間外が¥1,500/日で30日。続けられなければ退職になる',
          fx: { dailyCost: { yen: 1500, days: 30, label: '欠勤の穴埋めの時間外' } },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'defer', label: '留保し、60日後に業績で決めると伝える', note: '費用なし。余力−1。資金は残る。届かなければ信頼が下がる',
          fx: { flag: 'py_bonus_defer', slack: -1 },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'none', label: '積立はせず、賞与で還元する方針にする', note: '賞与の原資が¥1,000/日で90日。長く働く理由は薄い',
          fx: { dailyCost: { yen: 1000, days: 90, label: '賞与の原資' } },
