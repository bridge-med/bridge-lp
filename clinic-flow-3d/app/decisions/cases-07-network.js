  ...
  const CASES = [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'asis', label: '今のまま院長が書く', note: '費用なし。余力−1。遅れは続く。紹介が減るかもしれない',
          fx: { slack: -1 },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'asis', label: '電話のままにする', note: '電話と確認が¥400/日で60日。抜けの確率が残る',
          fx: { dailyCost: { yen: 400, days: 60, label: '電話と確認の手間' } },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'decline', label: '断る', note: '新患×0.97が60日。外来は守れる。地域の情報は入りにくくなる',
          fx: { newMul: { mul: 0.97, days: 60, label: '地域の情報が細る' } },
    ...
    },
    {
      ...
      choices: [
        { id: 'join', label: '参加し、医事が入力を担う', note: '¥800/日がずっと続く。導入14日は余力−1。定着すれば速い',
          req: { money: 50000 },
          fx: { dailyCost: { yen: 800, days: null, label: '連携ネットワーク' }, slack: -1, delayed: [{ days: 14, label: '入力が定着し連携が速くなる', fx: { slack: 2, trust: 1 } }] },
        ...
        { id: 'wait', label: '今は見送る', note: '紙とFAXが¥500/日で90日続く。周りが進むと置かれる確率',
          fx: { dailyCost: { yen: 500, days: 90, label: '紙とFAXの実費' } },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'onrequest', label: '求められたときだけ渡す', note: '費用なし。余力−1。今回のような行き違いが再発する確率',
          fx: { slack: -1 },
