 ...
 *
 * 役割: 体制で取る4つの加算(明細書発行体制等=届出不要・時間外対応体制・
 *       機能強化・電子的診療情報連携)について、
 *       (1) 届出・体制整備の可否判定(純関数) と (2) 受診1件あたりの計上行 を一元化する。
